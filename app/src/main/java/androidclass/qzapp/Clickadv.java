...
public class Clickadv extends AppCompatActivity {
    View viewLayout;
    ...
    Pre_questions3 mQuestions = new Pre_questions3();
        ...
        answer1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if(answer1.getText() == mAnswer)
                {
                    ...
                    //For CustomToast
                    Toast toast1 = Toast.makeText(Clickadv.this,"Toast:Gravity.TOP", Toast.LENGTH_SHORT);
    ...
    {
        Intent intent = new Intent(Clickadv.this, ResultActivity.class);
        Bundle b = new Bundle();
